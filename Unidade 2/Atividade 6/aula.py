...
print(f" As dos alunos Fulano, Fulana e Cicrano foram respectivamente: {turma}")
# Atividade de casa, fazer os exemplos do slides(2 att), as 4 atividades do slide 9 e os da últimas páginas.
